...
def send():
    ...
    tex.delete(1.0, END)
    msg = MIMEText('你是一头250斤于彦猪', 'plain', 'utf-8')
    msg['From'] = _format_addr('你是一头250斤于彦猪 <%s>' % from_addr)
    msg['To'] = _format_addr('你是一头250斤于彦猪 <%s>' % to_addr)
    msg['Subject'] = Header('你是一头250斤于彦猪...', 'utf-8').encode()
    i = 1
